...
def show_commune_popup(props):
    ...
    if blason and blason.lower() != "nan":
        ...
        # On récupère le nom et l'éventuelle extension
        name, ext = os.path.splitext(blason_name)
        
        # Si aucune extension n'est trouvée, on force '.png'
        if not ext:
        ...
        # 🔍 LIGNE DE DÉBOGAGE : Affiche l'URL exacte générée dans l'appli
        st.text(f"URL générée : {blason_url}")
