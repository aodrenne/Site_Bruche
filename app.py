...
def show_point_popup(obj):
    ...
    if photo and str(photo).lower() != "nan":
        ...
        # Sécurité : si l'extension est collée sans point (ex: IM67011249jpg), on corrige
        if photo_name.endswith("jpg") and not photo_name.endswith(".jpg"):
            photo_name = photo_name[:-3] + ".jpg"
        elif photo_name.endswith("png") and not photo_name.endswith(".png"):
            photo_name = photo_name[:-3] + ".png"
        elif photo_name.endswith("jpeg") and not photo_name.endswith(".jpeg"):
            photo_name = photo_name[:-4] + ".jpeg"
